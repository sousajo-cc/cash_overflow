...
std::string toString(LogLevel lvl){
  ...
  std::ostream& operator << (std::ostream& os, LogLevel& lvl) {
    switch(lvl) {
      case LogLevel::DBG : os << "DBG"; break;
      case LogLevel::INF : os << "INF"; break;
  ...
  public:
    ...
    fmt::color getColor(LogLevel lvl){
      switch(lvl) {
        case LogLevel::DBG : return fmt::color::white_smoke;
        case LogLevel::INF : return fmt::color::steel_blue;
        case LogLevel::WARN : return fmt::color::yellow;
        case LogLevel::ERR : return fmt::color::crimson;
        default: return fmt::color::white_smoke;
      }
    }
...
#endif//CASH_OVERFLOW_LOGGER_HPP
